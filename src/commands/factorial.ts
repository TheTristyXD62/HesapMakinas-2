  ...
  async run(interaction) {
    ...
    try {
      ...
      const finalEmbed = new EmbedBuilder()
        ...
        .setDescription(
          'Yapacağınız hesap işlemlerinde hiçbir veri saklanmamaktadır. Dilediğiniz gibi hesap yapabilirsiniz; ancak henüz tam fonksiyonlu değildir. Kullandığınız bu açık kaynaklı kod, Tristy tarafından tasarlanmış ve kodlanmıştır.',
        )
        .setTimestamp()
        .setFooter({
          text: `${interaction.client.user.username} 💗 Made By : Tristy`,
      ...
      const finalEmbed = new EmbedBuilder()
        ...
        .setTitle('Faktöriyel Hesaplayıcı')
        .setDescription(
          'Yapacağınız hesap işlemlerinde hiçbir veri saklanmamaktadır. Dilediğiniz gibi hesap yapabilirsiniz; ancak henüz tam fonksiyonlu değildir. Tristy tarafından tasarlanmış ve kodlanmıştır.',
        )
        .setTimestamp()
        .setFooter({
          text: `${interaction.client.user.username} 💗 Made By : Tristy`,
